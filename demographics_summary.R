...
demo <-  demog.data.flt
hist(demo$age, breaks = c(18,30, 40,50,60,70,80), freq = TRUE)
sum(demo$age<20) # 10 1.6%
sum(demo$age>70) # 19 3.1%
demo$ETHCAT2[demo$ETHCAT2=="White native"] = "White"
demo$ETHCAT2[demo$ETHCAT2=="White Other"] = "White"
demo$ETHCAT2[demo$ETHCAT2=="Mixed ethnic background"] = "Other"
...
listVars <- c("age", "sex","marry_align", "ETHCAT2","employment","children","edu_age_align","income_align","accommodation_occupy_align","sum_phq8",
              "comorb","depression_medication","num_contact","phone_status","phone_brand")
#Define categorical variables
catVars <- c("sex","marry_align", "ETHCAT2","employment","children","income_align","accommodation_occupy_align",
             "comorb","depression_medication","phone_status","phone_brand")
