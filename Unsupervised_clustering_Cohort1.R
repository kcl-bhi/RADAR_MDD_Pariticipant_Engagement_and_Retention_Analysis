...
demog.data.flt$ETHCAT2[demog.data.flt$ETHCAT2=="White native"] = "White"
demog.data.flt$ETHCAT2[demog.data.flt$ETHCAT2=="White Other"] = "White"
demog.data.flt$ETHCAT2[demog.data.flt$ETHCAT2=="Mixed ethnic background"] = "Other"
# 
demog.data.flt$phone_status[demog.data.flt$phone_status==3|demog.data.flt$phone_status==2]=0
...
# race subgroup
# pid_by_clusters_wmdata <- pid_by_clusters_wmdata %>%
#   filter(site != "ciber")
...
tabResults <- tableone::CreateTableOne(data=pid_by_clusters_wmdata, vars=listVars, 
                                       factorVars = catVars, 
                                       strata = c("cluster"), includeNA = F)
demo_table3 <- print(tabResults, nonnormal = listVars, 
                    formatOptions = list(big.mark = ","))
